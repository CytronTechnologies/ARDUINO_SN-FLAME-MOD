 ...
 * wiper to LCD VO pin (pin 3)
 ...
 Flame Sensor module to BBFuino
 *VCC to 5V 
 *GND to GND
 *DO to D2
 *AO to AO
...
#define Analog  A0  //Analog output of Flame Sensor Module connected to A0 of BBFuino
#define Digital 2   //Digital Output of Flame Sensor Module connected to D2 of BBfuino
...
void loop() {
  ...
  //display analog value from flame sensor 
  lcd.setCursor(3, 0);  //set LCD cursor to be after AN:
  lcd.print(AnalogValue);  //display the ADC value from AO of flame sensor
